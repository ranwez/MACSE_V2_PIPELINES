...
if( help == true)
{
  println """\
    ...
    usage example 1: nextflow P_macse_barcode.nf  --refSeq Homo_sapiens_NC_012920_COI_ref.fasta --seqToAlign Mammalia_BOLD_121180seq_COI.fasta --outPrefix Mammals_COI_2 --geneticCode 2
    usage example 2: ./nextflow ./P_macse_barcode.nf  --refSeq Mammalia/Homo_sapiens_NC_012920_COI_ref.fasta --seqToAlign Mammalia/Mammalia_BOLD_121180seq_COI.fasta --outPrefix Mammals_COI_2 --geneticCode 2 --javaMem 4000m --minClustSize 10 --maxRepresentativeSeqs 100
